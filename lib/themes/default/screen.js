...
var screen = function screen() {
  ...
  Object.keys(fontArgs).forEach(function (key) {
    ...
    normalizedFontArgs = _extends({}, normalizedFontArgs, (_extends2 = {}, _extends2[key] = fontName, _extends2));
    if (value.hasOwnProperty("googleFont") && value.googleFont) {
      var _extends3;

      googleFonts = _extends({}, googleFonts, (_extends3 = {}, _extends3[key] = value, _extends3));
    }
  });
